...
\newcommand{\theexam}{Test Submission}
...
\begin{question}
  \begin{enumerate}[label=(\alph*)]
      \item This is my answer to part (a)
      \item 

          \begin{tikzpicture}
              \draw (0,1) node[circle, black, draw,minimum size=1cm, label=above:Left Circle](A){};
              \draw (3,1) node[circle, black, draw,minimum size=1cm, label=above:Right Circle](B){};
              \draw (0,1) edge node {} (3,1);
          \end{tikzpicture}
